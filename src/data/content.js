  ...
  ru: {
    ...
    about: {
      ...
      usefulIf: {
        ...
        items: [
          'Нужно системно выстроить маркетинг: от стратегии и медиаплана до прозрачной аналитики и unit-экономики.',
          'Требуется снизить CPL/CAC без потери качества лидов и увеличить ROAS за счёт сегментации и тестов.',
          'Нужны CRM-воронки (email + SMS), реактивация базы и рост повторных обращений в B2B.',
          'Важно быстро запускать гипотезы, измерять эффект и масштабировать только то, что подтверждено данными.'
        ]
      }
    },
    cases: {
